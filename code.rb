...
twitter_data.each do |tweeter|
  print tweeter.keys[0] + ": "
  tweeter.each do |username, values|
    if values["number of followers"].nil?
      puts "NA"
    else
...
twitter_data.each do |tweeter|
  print tweeter.keys[0] + "'s latest tweet was  "
  tweeter.each do |username, values|
    if
      print values["last twenty tweets"][0].length
    end
    puts " characthers long."
  end
end
...
char_count = 0
twitter_data.each do |tweeter|
  print tweeter.keys[0] + "used"
  tweeter.each do |username, data|
    data["last twenty tweets"].each do |tweet|
      char_count += tweet.length
    end
    puts "#{tweeter.keys[0]}  used #{char_count} characters in their last twenty tweets"
    char_count = 0
  end
end
...
twitter_data.each do |tweeter|
  tweeter.each do |username, values|
    if values["number of followers"] > current_highest
      current_highest = values["number of followers"]
      popular_user = username
    end
  end
end

puts "#{popular_user} has the most followers"
...
twitter_data.each do |tweeter|
  tweeter.each do |username, values|
    if values["number of friends"] > current_highest
      current_highest = values["number of friends"]
      popular_friend = username
    end
  end
end

puts "#{popular_friend} has the most friends"

puts "==========="

num_tweets = 0
biggerst_tweeter = nil
twitter_data.each do |tweeter|
  tweeter.each do |username, values|
    if values["number of tweets"] > current_highest
      current_highest = values["number of tweets"]
      biggerst_tweeter = username
    end
  end
end

puts "#{biggerst_tweeter} has the most tweets"
...
miss_desc.each do |name|
  puts "#{name} does not have a description"
end
...
puts "\n"
puts "Does not have location: "
no_location.each do |name|
  puts "#{name}"
end
